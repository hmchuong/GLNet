...
python -m torch.distributed.launch --nproc_per_node=7 --use_env inspector.py \
--dataset_name "DeepGlobe" \
--data_path "/vinai/chuonghm/deep_globe" \
--n_class 7 \
--num_scaling_level 1 \
...
--supervision \
--log_path "/vinai/chuonghm/inspector/logs" \
--task_name "inspector_deepglobe_local0_resnetfpn_refinement4_weight_reg_supervision_640" \
