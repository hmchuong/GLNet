...
# --num_scaling_level 3 \
# --log_path "/vinai/chuonghm/inspector/logs" \
# --task_name "eval_inspector_deepglobe_local0_resnetfpn_weight_noreg" \
# --restore_path "/vinai/chuonghm/inspector/logs/inspector_deepglobe_local0_resnetfpn_weight_noreg/inspector_deepglobe_local0_resnetfpn_weight_noreg.pth" \
# --batch_size 6 \
# --sub_batch_size 6 \
# --patch_sizes 1224 996 640 \
# --size 640 \
...
--refinement 1 \
--log_path "/vinai/chuonghm/inspector/logs" \
--task_name "eval_inspector_deepglobe_local0_resnetfpn_weight_reg" \
--restore_path "/vinai/chuonghm/inspector/logs/inspector_deepglobe_local0_resnetfpn_weight_reg/inspector_deepglobe_local0_resnetfpn_weight_reg.pth" \
--batch_size 6 \
--sub_batch_size 6 \
--patch_sizes 1224 996 640 \
--size 640 \
